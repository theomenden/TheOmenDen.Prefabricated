...
public class ModerateHouseConfiguration extends StructureConfiguration {
	...
	public enum HouseStyle {
		...
		WORKSHOP_HOME(4, GuiLangKeys.MODERATE_WORKSHOP_HOME, new Identifier("prefab", "textures/gui/moderate_house_workshop_topdown.png"), 174, 131,
				"assets/prefab/structures/moderate_house_workshop.zip", 29, 21, 19, 14, 0),
		NETHER_HOME(5, GuiLangKeys.MODERATE_NETHER_HOME, new Identifier("prefab", "textures/gui/moderate_house_nether_topdown.png"), 141, 165,
				"assets/prefab/structures/moderate_house_nether.zip", 16, 15, 22, 0, 0),
		MOUNTAIN_HOME(6, GuiLangKeys.MODERATE_MOUNTAIN_HOME, new Identifier("prefab", "textures/gui/moderate_house_mountain_topdown.png"), 174, 99,
