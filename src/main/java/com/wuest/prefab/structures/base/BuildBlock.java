...
public class BuildBlock {
    ...
    public static BuildBlock SetBlockState(StructureConfiguration configuration, World world, BlockPos originalPos, BuildBlock block, Block foundBlock,
    ...
    private static BuildBlock SetBlockStateFromTagData(StructureConfiguration configuration, World world, BlockPos originalPos, BuildBlock block,
