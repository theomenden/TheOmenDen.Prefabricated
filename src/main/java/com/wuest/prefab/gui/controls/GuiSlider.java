...
public class GuiSlider extends Button {
    ...
    public GuiSlider(int xPos, int yPos, int width, int height, TextComponent prefix, TextComponent suf, double minVal, double maxVal, double currentVal, boolean showDec, boolean drawStr, OnPress handler, ISlider par) {
