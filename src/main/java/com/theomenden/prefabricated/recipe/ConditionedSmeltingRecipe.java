...
public class ConditionedSmeltingRecipe extends SmeltingRecipe {
    ...
    public ConditionedSmeltingRecipe(ResourceLocation id, String group, CookingBookCategory cookingBookCategory, Ingredient input, ItemStack output, float experience, int cookTime, String configName) {
