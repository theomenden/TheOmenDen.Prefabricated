...
public class ConditionedShapedRecipe extends ShapedRecipe {
    ...
    private static BooleanReferencePair<Map<String, Ingredient>> keyFromJson(JsonObject json) {
        ...
        return BooleanReferencePair.of(hasTags, map);
    }
    ...
    public static class Serializer implements RecipeSerializer<ConditionedShapedRecipe> {
        ...
        public @NotNull ConditionedShapedRecipe fromJson(ResourceLocation identifier, JsonObject jsonObject) {
            ...
            Map<String, Ingredient> map = ingredientResult.right();
            ...
            if (map.size() == 1 && map.containsKey(" ")) {
                ...
                return new ConditionedShapedRecipe(identifier, groupName, CraftingBookCategory.MISC, 3, 3, NonNullList.withSize(3 * 3, Ingredient.EMPTY), ItemStack.EMPTY, configName, ingredientResult.leftBoolean());
            }
