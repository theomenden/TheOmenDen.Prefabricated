...
public final class ConditionedShaplessRecipe extends ShapelessRecipe {
	...
	public static class Serializer implements RecipeSerializer<ConditionedShaplessRecipe> {
		public @NotNull ConditionedShaplessRecipe fromJson(ResourceLocation identifier, JsonObject jsonObject) {
		...
		public @NotNull ConditionedShaplessRecipe fromNetwork(ResourceLocation identifier, FriendlyByteBuf packetByteBuf) {
