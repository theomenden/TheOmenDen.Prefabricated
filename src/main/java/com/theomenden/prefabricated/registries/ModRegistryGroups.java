...
public class ModRegistryGroups {
    ...
    public static Component PREFABRICATED_TAB_TEXT = Component.literal(" (Prefabricated)").withStyle(ChatFormatting.DARK_AQUA);

    public static final CreativeModeTab MAIN_ITEM_GROUP = FabricItemGroup.builder()
                                                                    ...
                                                                    .displayItems((context, entries) ->
                                                                            BuiltInRegistries.ITEM.holders()
                                                                                                  .filter(itemReference -> itemReference.key().location().getNamespace().equals(Prefab.MODID))
    ...
    public static final CreativeModeTab BUILDING_BLOCK_GROUP = FabricItemGroup.builder()
                                                                              .title(Component.translatable("itemGroup.prefabricated.building_blocks").append(PREFABRICATED_TAB_TEXT))
                                                                              .icon(() -> new ItemStack(ModRegistry.LogoItem))
                                                                              .displayItems((context, entries) ->{
    ...
    public static final CreativeModeTab UTILITY_BLOCK_GROUP = FabricItemGroup.builder()
                                                                             .title(Component.translatable("itemGroup.prefabricated.utility_blocks").append(PREFABRICATED_TAB_TEXT))
                                                                             .icon(() -> new ItemStack(ModRegistry.LogoItem))
                                                                             .displayItems((context, entries) -> {
