    ...
    public void renderButton(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        if (this.isVisible()) {
            ...
            if (this.isBordered()) {
                ...
                guiGraphics.fill(this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1, this.getY() + this.height + 1, j);
            ...
            if (!string.isEmpty()) {
                ...
                if (!this.drawsTextShadow) {
                    o = guiGraphics.drawString(this.font, this.formatter.apply(string2, displayPos), m, n,j);
                } else {
                    o = guiGraphics.drawString(this.font, this.formatter.apply(string2, displayPos), m, n,j, true);
                }
            }
            ...
            if (!string.isEmpty() && bl && k < string.length()) {
                if (!this.drawsTextShadow) {
                    guiGraphics.drawString(this.font, this.formatter.apply(string.substring(k), this.cursorPos), p - 1, n,j);
                } else {
                    guiGraphics.drawString(this.font, this.formatter.apply(string.substring(k), this.cursorPos), o, n, j, true);
                }
            }
            ...
            if (!bl3 && this.suggestion != null) {
                if (!this.drawsTextShadow) {
                    ...
                    guiGraphics.drawString(this.font, "_", p - 1, n, -8355712);
                } else {

                    guiGraphics.drawString(this.font, "_", p - 1, n, -8355712, true);
                }
            }
            ...
            if (bl2) {
                if (bl3) {
                    ...
                    guiGraphics.fill(p, var10002, var10003, var10004 + 9, -3092272);
                } else {
                    if (!this.drawsTextShadow) {
                        guiGraphics.drawString(this.font, "_", p, n, j);
                    } else {
                        guiGraphics.drawString(this.font, "_", p, n, j);
                        guiGraphics.drawString(this.font, "_", p,n,j, true);
                    }
                }
            }
