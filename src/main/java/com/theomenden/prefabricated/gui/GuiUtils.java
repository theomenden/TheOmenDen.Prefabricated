...
public class GuiUtils {
     ...
     *
     * @param guiGraphics   the graphics provider
     * @param atlasLocation the ResourceLocation object that contains the desired image
     * @param x             x-axis offset
     * @param y             y-axis offset
     * @param z             bound resource location image z-offset
     * @param width         the desired box width
     * @param height        the desired box height
     * @param textureWidth  the width of the box texture in the resource location image
     * @param textureHeight the height of the box texture in the resource location image
     */
    public static void renderProvidedTexture(GuiGraphics guiGraphics, ResourceLocation atlasLocation, int x, int y, int z, int width, int height, int textureWidth, int textureHeight) {

        guiGraphics.blit(atlasLocation, x,y,0, z, width, height, textureWidth, textureHeight);
    }
