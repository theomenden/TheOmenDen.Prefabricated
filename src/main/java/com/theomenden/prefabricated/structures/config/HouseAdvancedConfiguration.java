...
public class HouseAdvancedConfiguration extends StructureConfiguration {
    ...
    public enum HouseStyle {
        MANOR(0, GuiLangKeys.ADVANCED_HOUSE_MANOR, new ResourceLocation(Prefab.MODID, "textures/gui/house_advanced_manor.png"),
                "assets/prefabricated/structures/house_advanced_manor.zip"),
        WORKSHOP(1, GuiLangKeys.ADVANCED_HOUSE_WORKSHOP, new ResourceLocation(Prefab.MODID, "textures/gui/house_advanced_workshop.png"),
                "assets/prefabricated/structures/house_advanced_workshop.zip"),
        ESTATE(2, GuiLangKeys.ADVANCED_HOUSE_ESTATE, new ResourceLocation(Prefab.MODID, "textures/gui/house_advanced_estate.png"),
                "assets/prefabricated/structures/house_advanced_estate.zip");
