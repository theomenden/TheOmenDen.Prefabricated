...
public class HouseImprovedConfiguration extends StructureConfiguration {
    ...
    public enum HouseStyle {
        SPRUCE_HOME(0, GuiLangKeys.IMPROVED_HOUSE_SPRUCE, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_spruce.png"),
                "assets/prefabricated/structures/house_improved_spruce.zip"),
        ACACIA_HOME(1, GuiLangKeys.IMPROVED_HOUSE_ACACIA, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_acacia.png"),
                "assets/prefabricated/structures/house_improved_acacia.zip"),
        EARTHEN_HOME(2, GuiLangKeys.IMPROVED_EARTHEN_HOME, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_earthen.png"),
                "assets/prefabricated/structures/house_improved_earthen.zip"),
        JUNGLE_TREE_HOME(3, GuiLangKeys.IMPROVED_JUNGLE_HOME, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_jungle.png"),
                "assets/prefabricated/structures/house_improved_jungle.zip"),
        NETHER_HOME(4, GuiLangKeys.IMPROVED_NETHER_HOME, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_nether.png"),
                "assets/prefabricated/structures/house_improved_nether.zip"),
        MOUNTAIN_HOME(5, GuiLangKeys.IMPROVED_MOUNTAIN_HOME, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_mountain.png"),
                "assets/prefabricated/structures/house_improved_mountain.zip"),
        ACACIA_HOME2(6, GuiLangKeys.IMPROVED_HOUSE_ACACIA_2, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_acacia_2.png"),
                "assets/prefabricated/structures/house_improved_acacia_2.zip"),
        MODERN_HOME(7, GuiLangKeys.IMPROVED_HOUSE_MODERN, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_modern.png"),
                "assets/prefabricated/structures/house_improved_modern.zip"),
        CRIMSON_HOME(8, GuiLangKeys.IMPROVED_HOUSE_CRIMSON, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_crimson.png"),
                "assets/prefabricated/structures/house_improved_crimson.zip"),
        TOWER_HOME(9, GuiLangKeys.IMPROVED_HOUSE_TOWER, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_tower.png"),
                "assets/prefabricated/structures/house_improved_tower.zip"),
        HOBBIT_HOME(10, GuiLangKeys.IMPROVED_HOUSE_HOBBIT, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_hobbit.png"),
                "assets/prefabricated/structures/house_improved_hobbit.zip"),
        COTTAGE_HOME(11, GuiLangKeys.IMPROVED_HOUSE_COTTAGE, new ResourceLocation(Prefab.MODID, "textures/gui/house_improved_cottage.png"),
                "assets/prefabricated/structures/house_improved_cottage.zip");
