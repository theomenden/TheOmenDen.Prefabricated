...
import com.theomenden.prefabricated.structures.config.enums.*;
...
public class BasicStructureConfiguration extends StructureConfiguration {
    ...
    public enum EnumBasicStructureName {
        ...
        MachineryTower("machinery_tower", "item.prefabricated.item_machinery_tower", "item_machinery_tower", MachineryTowerOptions.Default, true),
        DefenseBunker("defense_bunker", "item.prefabricated.item_defense_bunker", "item_defense_bunker", DefenseBunkerOptions.Default, false),
        MineshaftEntrance("mineshaft_entrance", "item.prefabricated.item_mineshaft_entrance", "item_mineshaft_entrance", MineshaftEntranceOptions.Default, true),
        EnderGateway("ender_gateway", "item.prefabricated.item_ender_gateway", "item_ender_gateway", EnderGatewayOptions.Default, false),
        AquaBase("aqua_base", "item.prefabricated.item_aqua_base", "item_aqua_base", AquaBaseOptions.Default, false),
        GrassyPlain("grassy_plain", "item.prefabricated.item_grassy_plain", "item_grassy_plain", GrassyPlainOptions.Default, false),
        MagicTemple("magic_temple", "item.prefabricated.item_magic_temple", "item_magic_temple", MagicTempleOptions.Default, false),
        WatchTower("watch_tower", "item.prefabricated.item_watch_tower", "item_watch_tower", WatchTowerOptions.Default, true),
        WelcomeCenter("welcome_center", "item.prefabricated.item_welcome_center", "item_welcome_center", WelcomeCenterOptions.Default, true),
        Jail("jail", "item.prefabricated.item_jail", "item_jail", JailOptions.Default, false),
        Saloon("saloon", "item.prefabricated.item_saloon", "item_saloon", SaloonOptions.Default, false),
        SkiLodge("ski_lodge", "item.prefabricated.item_ski_lodge", "item_ski_lodge", SkiLodgeOptions.Default, false),
        WindMill("wind_mill", "item.prefabricated.item_wind_mill", "item_wind_mill", WindMillOptions.Default, false),
        TownHall("town_hall", "item.prefabricated.item_town_hall", "item_town_hall", TownHallOptions.Default, false),
        NetherGate("nether_gate", "item.prefabricated.item_nether_gate", "item_nether_gate", NetherGateOptions.AncientSkull, false),
        AquaBaseImproved("aqua_base_improved", "item.prefabricated.item_aqua_base_improved", "item_aqua_base_improved", AquaBaseImprovedOptions.Default, false),
        VillagerHouses("villager_houses", "item.prefabricated.item_villager_houses", "item_villager_houses", VillagerHouseOptions.FLAT_ROOF, true),
        WarehouseImproved("warehouse_improved", "item.prefabricated.item_warehouse_improved", "item_warehouse_improved", WarehouseImprovedOptions.Default, true),
        Warehouse("warehouse", "item.prefabricated.item_warehouse", "item_warehouse", WarehouseOptions.Default, true),
        ModernBuildings("modern_buildings", "item.prefabricated.item_modern_buildings", "item_modern_buildings", ModernBuildingsOptions.HipsterFruitStand, true),
        Farm("farm", "item.prefabricated.item_farm", "item_farm", FarmOptions.ElevatedFarm, true),
        FarmImproved("farm_improved", "item.prefabricated.item_farm_improved", "item_farm_improved", FarmImprovedOptions.AutomatedFarm, true),
        FarmAdvanced("farm_advanced", "item.prefabricated.item_farm_advanced", "item_farm_advanced", FarmAdvancedOptions.AutomatedBambooFarm, true),
        ModernBuildingsImproved("modern_buildings_improved", "item.prefabricated.item_modern_buildings_improved", "item_modern_buildings_improved", ModernBuildingsImprovedOptions.ConstructionSite, true),
        ModernBuildingsAdvanced("modern_buildings_advanced", "item.prefabricated.item_modern_buildings_advanced", "item_modern_buildings_advanced", ModernBuildingsAdvancedOptions.TreeHouse, true);
        ...
        EnumBasicStructureName(
            ...
            if (itemTextureLocation != null) {
                this.itemTextureLocation = new ResourceLocation("prefabricated", itemTextureLocation);
            }
